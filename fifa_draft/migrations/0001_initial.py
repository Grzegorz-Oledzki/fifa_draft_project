    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(blank=True, default=users.models.Profile, related_name='members', to='users.profile')),
                ('owner', models.ForeignKey(db_constraint=False, default=users.models.Profile, on_delete=django.db.models.deletion.CASCADE, to='users.profile')),
                ('picking_person', models.ManyToManyField(blank=True, default=users.models.Profile, related_name='picking_person', to='users.profile')),
            ],
            options={
                'ordering': ['created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(default=users.models.Profile, on_delete=django.db.models.deletion.CASCADE, to='users.profile')),
