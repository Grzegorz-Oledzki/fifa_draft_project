...
class Player(models.Model):
    ...
    sofifa_id = models.IntegerField(_('sofifa_id'))
    player_url = models.CharField(_("player_url"), max_length=50)
    short_name = models.CharField(_("short_name"), max_length=50)
    player_positions = models.CharField(_("player_positions"), max_length=15, null=True)
    ...
    club_name = models.CharField(_("club_name"), max_length=50, null=True)
    preferred_foot = models.CharField(_("preferred_foot"), max_length=6, null=True)
    weak_foot = models.IntegerField(_("weak_foot"), null=True)
    skill_moves = models.IntegerField(_("skill_moves"), null=True)
    work_rate = models.CharField(_("work_rate"), max_length=50, null=True)
    ...
    player_face_url = models.CharField(_("player_face_url"), max_length=200, null=True)
    club_logo_url = models.CharField(_("club_logo_url"), max_length=200, null=True)
    nation_flag_url = models.CharField(_("nation_flag_url"), max_length=200, null=True)
